...
<button class="mt-5 default-light-btn-lg" id="start-btn" onclick="setProgressLocalStorage('welcome_done', true);gameStoryProgressTicker();updateCitizenLocation('SCBPO');">START NEW GAME</button><br>`;
...
borderPatrolDialogue1 =
  ...
  <button class="mt-4 dialogue-response-btn" onclick="setProgressLocalStorage('show_identification', true);saveUserInputValue('citizen_username', '#citizen-username-input');saveUserInputValue('citizen_identifier', '#citizen-pronoun-input');saveUserInputValue('citizen_preferred_address', '#citizen-preferred-address-input');fadeOut('#border-patrol-dialogue-1');refreshPage();">Sure, here it is, officer</button>
</div>`
...
<button class="mt-4 dialogue-response-btn" onclick="setProgressLocalStorage('show_identification_2', true);gameStoryProgressTicker();fadeOut('#left-main-frame');">Okay</button>
<button class="mt-4 dialogue-response-btn" onclick="setProgressLocalStorage('show_identification_2', true);gameStoryProgressTicker();fadeOut('#left-main-frame');">Thank you, officer</button>
</div>`
...
<button class="mt-4 dialogue-response-btn" onclick="fadeOut('#border-patrol-dialogue-3');fadeInNormalDelay('#border-patrol-dialogue-4');">And you're not?</button>
<button class="mt-4 dialogue-response-btn" onclick="fadeOut('#border-patrol-dialogue-3');fadeInNormalDelay('#border-patrol-dialogue-4');">I missed you too, ${siblingShort}</button>
</div>
...
<button class="mt-4 dialogue-response-btn" onclick="fadeOut('#border-patrol-dialogue-4');fadeInNormalDelay('#border-patrol-dialogue-5');">*sigh*</button>
<button class="mt-4 dialogue-response-btn" onclick="fadeOut('#border-patrol-dialogue-4');fadeInNormalDelay('#border-patrol-dialogue-5');">Is it really that bad?</button>
</div>
...
<button class="mt-4 dialogue-response-btn" onclick="setProgressLocalStorage('family_reunited', true);gameStoryProgressTicker();fadeOut('#left-main-frame');">Okay, let's go.</button>
<button class="mt-4 dialogue-response-btn" onclick="setProgressLocalStorage('family_reunited', true);gameStoryProgressTicker();fadeOut('#left-main-frame');">Thanks ${citizenCallsign}, really appreciate it.</button>
</div>`
...
razeBarPrologueTutorial =
  ...
  <button class="mt-4 dialogue-response-btn" onclick="fadeOut('#raze-bar-prologue-1');fadeInNormalDelay('#raze-bar-prologue-2');">Follow ${sibling}</button>
</div>
...
<button class="mt-4 dialogue-response-btn" onclick="fadeOut('#raze-bar-prologue-2');fadeInNormalDelay('#raze-bar-prologue-3');">Yeah...</button>
<button class="mt-4 dialogue-response-btn" onclick="fadeOut('#raze-bar-prologue-2');fadeInNormalDelay('#raze-bar-prologue-3');">What's going on?</button>
</div>
...
<button class="mt-4 dialogue-response-btn" onclick="fadeOut('#raze-bar-prologue-3');fadeInNormalDelay('#raze-bar-prologue-4-b');">I don't really gamble, ${citizenCallsign}.</button>
<button class="mt-4 dialogue-response-btn" onclick="fadeOut('#raze-bar-prologue-3');fadeInNormalDelay('#raze-bar-prologue-4-a');">How do I play it?</button>
</div>
...
<button class="mt-4 dialogue-response-btn" onclick="fadeOut('#raze-bar-prologue-4-a');fadeInNormalDelay('#raze-bar-prologue-5');">And if I lose?</button>
<button class="mt-4 dialogue-response-btn" onclick="fadeOut('#raze-bar-prologue-4-a');fadeInNormalDelay('#raze-bar-prologue-5');">That sounds easy!</button>
</div>
...
<button class="mt-4 dialogue-response-btn" onclick="fadeOut('#raze-bar-prologue-4-b');fadeInNormalDelay('#raze-bar-prologue-4-a');">Okay, tell me about it.</button>
</div>
...
<button class="mt-4 dialogue-response-btn" onclick="fadeOut('#raze-bar-prologue-5');fadeInNormalDelay('#raze-bar-prologue-6');">Hmm...</button>
<button class="mt-4 dialogue-response-btn" onclick="fadeOut('#raze-bar-prologue-5');fadeInNormalDelay('#raze-bar-prologue-6');">Doesn't sound easy money.</button>
</div>
...
<button class="mt-4 dialogue-response-btn" onclick="fadeOut('#raze-bar-prologue-6');fadeInNormalDelay('#raze-bar-prologue-7');">Anything else I should know?</button>
</div>
...
<button class="mt-4 dialogue-response-btn" onclick="fadeOut('#raze-bar-prologue-7');fadeInNormalDelay('#raze-bar-prologue-8');">I'm ready but...</button>
<button class="mt-4 dialogue-response-btn" onclick="fadeOut('#raze-bar-prologue-7');fadeInNormalDelay('#raze-bar-prologue-8');">I think I get it now.</button>
</div>
...
<button class="mt-4 dialogue-response-btn" onclick="setProgressLocalStorage('raze_tutorial_complete', true);gameStoryProgressTicker();icreaseCitizenCash(20);fadeOut('#raze-prologue-tutorial');">You're the best, ${siblingShort}.</button>
<button class="mt-4 dialogue-response-btn" onclick="setProgressLocalStorage('raze_tutorial_complete', true);gameStoryProgressTicker();icreaseCitizenCash(20);fadeOut('#raze-prologue-tutorial');">I'll do my best.</button>
</div>
</div>
`
